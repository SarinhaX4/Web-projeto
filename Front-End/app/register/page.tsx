...
import { register } from "@/lib/api/auth.service" // Import the register service
...
export default function RegisterPage() {
  ...
  const [registerError, setRegisterError] = useState<string | null>(null); // State for registration errors
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await register({
        username: name, // Assuming 'name' maps to 'username' in backend
        email,
        password,
        phone,
        birthDate, // May need formatting based on backend
        cpf, // May need formatting based on backend
        // Add other fields required by your backend registration DTO
        address: "", // Assuming address is optional or can be updated later
